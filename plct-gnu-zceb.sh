...
git fetch lin 
git checkout lin/riscv-binutils-experiment-zceb
...
./configure --prefix="$PWD/opt-riscv-rv64zceb" --with-arch=rv64imac_zceb --with-abi=lp64d --with-multilib-generator="rv64imac_zceb-lp64d--"
